...
def register(bot) -> None:
    ...
    bot.add_callback_query(r"^reveal_card_", reveal_card_callback)
    bot.add_callback_query(r"^pause_reading$", pause_reading_callback)
    bot.add_callback_query(r"^show_final_result$", show_final_result_callback)
    bot.add_callback_query(r"^tarot_detail$", tarot_detail_callback)
    bot.add_callback_query(r"^tarot_luck$", tarot_luck_callback)
    bot.add_callback_query(r"^tarot_again$", tarot_again_callback)
    bot.add_callback_query(r"^back_to_tarot$", back_to_tarot_callback)
